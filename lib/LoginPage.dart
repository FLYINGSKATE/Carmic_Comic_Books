...
class _LoginPageState extends State<LoginPage> {
  ...
  var _bacgroundColor = Color(0xffFF0000);
      ...
      children: <Widget>[
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Image.asset('assets/images/carmicsfg.png'),
                ),
                Padding(
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            color: Color(0xffFF0000).withOpacity(_loginOpacity),
          ),
          child: Column(
            children: <Widget>[
              Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text("Please Tap Below to Continue! Reading Carmics Comic Books!",textAlign: TextAlign.center,style: TextStyle(
                  fontFamily: "present",
                  fontSize: 30.0,
                  color: Colors.white,
                ),),
  ...
  Widget build(BuildContext context) {
    ...
    switch(_pageState){
      case 0:
        _bacgroundColor = Color(0xffFF0000);
...
class InputWithIcon extends StatefulWidget {
  ...
  InputWithIcon({this.hintText,this.icon});
...
class AuthBtns extends StatefulWidget {
  final String btnText;
  final IconData icon;
  AuthBtns({this.btnText,this.icon});
